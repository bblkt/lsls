...
answer.extend(
    [
        ...
        InlineQueryResultArticle(
            ...
            input_message_content=InputTextMessageContent("ليزا طفيها"),
        ),
        InlineQueryResultArticle(
            title="تكرار التشغيل",
