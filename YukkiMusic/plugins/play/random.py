...
async def musicme(client, message):
       ...
       if message.chat.id not in disable:
         ...
         await message.reply_voice(url,caption="-› [• 𝑷𝒓𝒐𝒑𝒆𝒓𝒕𝒚 𝗹𝗶𝘀𝗮 •](t.me/sourcerona)")
...
async def ava(client, message):
       ...
       if message.chat.id not in disable_A:
         ...
         url = f"https://t.me/JuuuT/{rl}"
         await message.reply_photo(url,caption="-› [• 𝑷𝒓𝒐𝒑𝒆𝒓𝒕𝒚 𝗹𝗶𝘀𝗮 •](t.me/sourcerona)")
         
@app.on_message(filters.regex("^افتارات عيال$") & filters.group)
async def ava(client, message):
       if message.chat.id in disable_A:
...
async def ava(client, message):
       ...
       if message.chat.id not in disable_A:
         ...
         url = f"https://t.me/JuuuT/{rl}"
         await message.reply_photo(url,caption="-› [• 𝑷𝒓𝒐𝒑𝒆𝒓𝒕𝒚 𝗹𝗶𝘀𝗮 •](t.me/JuuuT)")
         
@app.on_message(filters.regex("^افتارات بنات$") & filters.group)
async def ava(client, message):
       if message.chat.id in disable_A:
...
@app.on_message(filters.regex("^افتارات مكس$") & filters.group)
async def ava(client, message):
       if message.chat.id in disable_A:
...
@app.on_message(filters.regex("^اقتباسات$"))
...
async def hyder1(client, message):
       ...
       if message.chat.id not in disable_h:
         rl = random.randint(1331,1795)
         url = f"https://t.me/sourcerona/{rl}"
         await message.reply_photo(url,caption="-› [• 𝑷𝒓𝒐𝒑𝒆𝒓𝒕𝒚 𝗹𝗶𝘀𝗮 •](t.me/JuuuT)")
