    ...
    await query.edit_message_media(
       ...
       reply_markup=InlineKeyboardMarkup(
          [
               [
                    InlineKeyboardButton(
                        "◌sᴏᴜʀᴄᴇ ʟɪsᴀ◌", url=f"t.me/sourcerona"),
                    InlineKeyboardButton(
...
async def eslam(_, query: CallbackQuery):
    ...
    await query.edit_message_media(
       ...
       reply_markup=InlineKeyboardMarkup(
          [
               [
                    InlineKeyboardButton("", url=f"t.me/r_j_y"),
                    InlineKeyboardButton("رجوع", callback_data="ko")
                ],[
                    InlineKeyboardButton("", url=f"t.me/r_j_y"),
                ],[
                    InlineKeyboardButton("◌sᴏᴜʀᴄᴇ ʟɪsᴀ◌", callback_data="fft"),
...
async def spo(_, query: CallbackQuery):
    ...
    await query.edit_message_media(
       InputMediaVideo(
           ...
           "◌ هلا فيك في قسم تشغيل اغاني Spotify ♪\n\n• تقدر تشغيل الاغاني عن طريق الرد على الرابط او وضعه مع الامر .\n\n• مثال : [ `ليزا شغلي https://open.spotify.com/track/2GQB3Xe1J9D2sK90AtHfhI?si=aIuly9l-T-Gy5GvfZxpUiw&context=spotify%3Aplaylist%3A37i9dQZF1DXcJUwMZo8Ss1i=1616715870&l=ar` ]\n\n**تابع الفيديو للتوضيح اكثير .**"
       ),
       reply_markup=InlineKeyboardMarkup(
            [
                [
