    ...
    async def join_call(
        ...
        try:
            ...
            try:
                ...
                raise AssistantErr(
                    "• ماحصلت مكالمة شغالة .. تأكد من تشغيل المكالمة ..\n\n- اذا كانت المكالمة قيد التشغيل يرجى إغلاقها وإعادة تشغيلها .\n- اذا استمرت المشكلة فقم بكتابة { ريستارت }"
                )
        except AlreadyJoinedError:
            raise AssistantErr(
                "• الحساب المساعد بالفعل موجود بالمكالمة..\n\n- تحدث هذي المشكلة غالبًا عند محاولة تشغيل 2 بوقتٍ واحد .\n - اذا لم يتم تشغيل شيء فقم بإغلاق المحادثة الصوتية وإعادة تشغيلها..\n- اذا استمرت المشكلة فقم بكتابة { ريستارت }"
            )
